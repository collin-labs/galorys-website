...
export function PlayerProfile({ player, team, teammates }: PlayerProfileProps) {
          ...
          >
            ...
            <div className="flex flex-wrap gap-3 mb-6">
              <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-muted border border-border">
                ...
                <span className="text-sm text-foreground">{team.gameLabel}</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-muted border border-border">
                <Calendar className="w-4 h-4 text-muted-foreground" />
                <span className="text-sm text-foreground">Desde {player.joinedAt}</span>
              </div>
            </div>
            ...
            {player.achievements && player.achievements.length > 0 && (
              <div className="mb-6">
                <h3 className="font-semibold text-foreground mb-2">Conquistas</h3>
                <div className="space-y-2">
                  {player.achievements.map((achievement, i) => (
                    <div key={i} className="flex items-center gap-2 text-muted-foreground">
                      <span className="text-galorys-purple">🏆</span>
                      {achievement}
                    </div>
                  ))}
                </div>
                  ...
                  >
                    <div className="relative aspect-[4/5] overflow-hidden bg-gradient-to-br from-galorys-purple/20 to-galorys-pink/20">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-4">
                        ...
                        <p className="text-white/70 text-sm">{teammate.role}</p>
                      </div>
                    </div>
                  </motion.div>
                </Link>
