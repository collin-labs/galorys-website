...
export default function NovoBannerPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(error.message || "Erro ao criar banner. Tente novamente.")
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-white">Novo Banner</h1>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="max-w-2xl">
        <div className="bg-[#14141b] border border-white/10 rounded-xl p-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              id="title"
              placeholder="Ex: Campeão Mundial 2024"
          ...
          <div className="space-y-2">
            ...
            <Input
              id="imageUrl"
              placeholder="/imagens/banner.jpg ou https://..."
            ...
            <p className="text-xs text-muted-foreground">
              Coloque a imagem na pasta /public/imagens e use o caminho relativo
            </p>
          </div>
        ...
        <div className="flex items-center gap-3 mt-6">
          <Button type="submit" className="bg-green-600 hover:bg-green-700" disabled={loading}>
            <Save className="w-4 h-4 mr-1" /> {loading ? "Criando..." : "Criar"}
          </Button>
